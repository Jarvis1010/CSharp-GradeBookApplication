...
namespace GradeBook.GradeBooks
{
    public abstract class BaseGradeBook
    {
        ...
        public virtual double GetGPA(char letterGrade, StudentType studentType)
        {
            ...
            {
                case 'A':
                    return (IsWeighted && (studentType == StudentType.DualEnrolled || studentType == StudentType.Honors)) ? 5 : 4;
                case 'B':
                    return (IsWeighted && (studentType == StudentType.DualEnrolled || studentType == StudentType.Honors)) ? 4 : 3;
                case 'C':
                    return (IsWeighted && (studentType == StudentType.DualEnrolled || studentType == StudentType.Honors)) ? 3 : 2;
                case 'D':
                    return (IsWeighted && (studentType == StudentType.DualEnrolled || studentType == StudentType.Honors)) ? 2 : 1;
            }
            return 0;
        }
